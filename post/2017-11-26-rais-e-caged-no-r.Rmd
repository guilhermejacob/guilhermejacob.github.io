...
# carrega funções
downloader::source_url( "https://github.com/guilhermejacob/guilhermejacob.github.io/blob/master/scripts/mtps.R" )
...
htmltools::HTML('<div style="position:relative;height:0;padding-bottom:56.21%"><iframe src="https://www.youtube.com/embed/7_Agt_nLHPY?ecver=2" style="position:absolute;width:100%;height:100%;left:0" width="641" height="360" frameborder="0" gesture="media" allowfullscreen></iframe></div>')
```