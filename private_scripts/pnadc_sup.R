...
catalog_pnadc_sup <-
  function( output_dir , ... ){
    ...
    # define filename
    catalog[ , "output_filename" ] <- paste0( output_dir , paste( "pnadc" , catalog[ , "topic" ] , catalog[ , "quarter" ] , catalog[ , "year" ] ) , ".fst" )
...
# build datavault
datavault_pnadc_sup <- function( catalog , datavault_dir , skipExist = TRUE ) {
  ...
  # print message
  cat( "\npnadc_sup datavault was built at" , datavault_dir , "\n" )
